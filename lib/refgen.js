...
exports.nuid = function(){
	...
	var ref = /*l[Math.floor(Math.random() * 9)] + l[Math.floor(Math.random() * 10)] + l[Math.floor(Math.random() * 10)] + l[Math.floor(Math.random() * 9)] + */l[Math.floor(Math.random() * 9)] + l[Math.floor(Math.random() * 10)] + l[Math.floor(Math.random() * 10)] + l[Math.floor(Math.random() * 10)] + l[Math.floor(Math.random() * 10)] + l[Math.floor(Math.random() * 10)];
	return ref;
}